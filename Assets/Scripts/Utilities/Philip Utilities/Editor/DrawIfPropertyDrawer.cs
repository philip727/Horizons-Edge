...
namespace Philip.Editor
{
    ...
    public class DrawIfPropertyDrawer : PropertyDrawer
    {
        ...
        {
            if (!ShowMe(property) && drawIf.disablingType == ConditionalFieldAttribute.DisablingType.DontDraw)
                return 0f;
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            else if (drawIf.disablingType == ConditionalFieldAttribute.DisablingType.ReadOnly)
            {
                GUI.enabled = false;
                EditorGUI.PropertyField(position, property, label);
                GUI.enabled = true;
